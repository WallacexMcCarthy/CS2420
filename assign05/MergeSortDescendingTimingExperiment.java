...
public class MergeSortDescendingTimingExperiment extends ArrayListSortTimingExperiment{
     ...
     */
    public MergeSortDescendingTimingExperiment(String problemSizeDescription, int problemSizeMin, int problemSizeCount, int problemSizeStep, int experimentIterationCount) {
