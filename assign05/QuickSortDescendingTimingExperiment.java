...
public class QuickSortDescendingTimingExperiment extends ArrayListSortTimingExperiment{
     ...
     */
    public QuickSortDescendingTimingExperiment(String problemSizeDescription, int problemSizeMin, int problemSizeCount, int problemSizeStep, int experimentIterationCount) {
