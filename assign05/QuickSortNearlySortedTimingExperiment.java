...
public class QuickSortNearlySortedTimingExperiment extends ArrayListSortTimingExperiment{
     ...
     */
    public QuickSortNearlySortedTimingExperiment(String problemSizeDescription, int problemSizeMin, int problemSizeCount, int problemSizeStep, int experimentIterationCount) {
